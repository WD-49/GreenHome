    ...
    <div class="container-xxl">
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Tài khoản <b>{{ $admins->name }}</b></h4>
            </div>


            <div class="ms-auto">
                <a href="{{ route('admin.account.listAdmins') }}" class="btn btn-sm btn-outline-secondary shadow-sm">
                        ...
                        <div class="align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="overflow-hidden ms-4">
                                    <h4 class="m-0 text-dark fs-20">{{ $admins->name }}</h4>
                                    <p class="my-1 text-muted fs-16">{{ $admins->email }}</p>
                                    ...
                                    @if ($admins->profile)
                                        <div class="mt-3 text-start">
                                            ...
                                            <p class="mb-1 small"><strong><i
                                                    ...
                                                    chỉ:</strong>
                                                {{ $admins->profile->address ?: 'Chưa cập nhật' }}</p>
                                ...
                                <a class="nav-link p-2" id="tab-orders" data-bs-toggle="tab" data-bs-target="#pane-orders"
                                    ...
                                    <span class="d-none d-sm-block">Đơn hàng
                                        @if (isset($admins->orders_count) && $admins->orders_count > 0)
                                            <span
                                                class="badge rounded-pill bg-info ms-1">{{ $admins->orders_count }}</span>
                                        @endif
                                    </span>
                                </a>
                            </li>
                                        ...
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <div class="row g-3"> {{-- Sử dụng g-3 để tạo khoảng cách giữa các cột --}}
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="fs-14 mb-0"><a href="mailto:{{ $admins->email }}"
                                                            class="text-primary text-decoration-underline">{{ $admins->email }}</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="fs-14 mb-0">{{ $admins->profile->phone ?: 'Chưa cập nhật' }}
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="fs-14 mb-0">
                                                        {{ $admins->profile->address ?: 'Chưa cập nhật' }}
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="fs-14 mb-0">
                                                        {{ $admins->profile->birth_date ? \Carbon\Carbon::parse($admins->profile->birth_date)->format('d/m/Y') : 'Chưa cập nhật' }}
                                                    </p>
                                                </div>
