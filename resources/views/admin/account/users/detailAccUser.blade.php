                        ...
                        <ul class="nav nav-tabs nav-fill" id="userTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="orders-tab" data-bs-toggle="tab"
                                    ...
                                    {{-- Giả sử $user->orders_count được truyền từ controller --}}
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="cart-tab" data-bs-toggle="tab" data-bs-target="#cart"
                                    ...
                                    {{-- Giả sử $user->cart_items_count được truyền từ controller --}}
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="comments-tab" data-bs-toggle="tab" data-bs-target="#comments"
                                    ...
                                    @if ($user->comments()->withTrashed()->count() > 0)
                                        <span
                                            class="badge rounded-pill bg-secondary ms-1">{{ $user->comments()->withTrashed()->count() }}</span>
                                    @endif
                                </button>
                            </li>
                        </ul>
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="userTabsContent">
                            ...
                            <div class="tab-pane fade" id="cart" role="tabpanel" aria-labelledby="cart-tab">
                                ...
                                {{-- Giả sử $user->cartItems là một collection các sản phẩm trong giỏ --}}
                            ...
                            <div class="tab-pane fade" id="comments" role="tabpanel" aria-labelledby="comments-tab">
                                ...
                                @if ($user->comments()->withTrashed()->get()->isEmpty())
                                    <div class="alert alert-light text-center" role="alert">
                                ...
                                @else
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped table-sm">
                                            ...
                                            <tbody>
                                                @foreach ($user->comments()->withTrashed()->orderBy('created_at', 'desc')->get() as $comment)
                                                    <tr>
                                                        <td>{{ $comment->id }}</td>
