        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.comments.index') }}" class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="product_name" class="form-control" value="{{ request('product_name') }}" placeholder="Nhập tên sản phẩm">
                </div>

                <!-- Tên người dùng -->
                <div class="col-md-3">
                    <label class="form-label">Tên người dùng</label>
                    <input type="text" name="user_name" class="form-control" value="{{ request('user_name') }}" placeholder="Nhập tên người dùng">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="comment_date" class="form-control" value="{{ request('comment_date') }}">
                </div>
                ...
                <tbody>
                    ...
                    <tr id="comment-row-{{ $comment->id }}">
                        ...
                        <td class="d-flex justify-content-center gap-1">
                            ...
                            <button class="btn btn-success btn-sm btn-approve" data-id="{{ $comment->id }}" title="Duyệt">
                                <i class="fas fa-check"></i>
                            </button>
                            @endif

                            @if($comment->status === 'hiển thị')
                            <button class="btn btn-warning btn-sm btn-hide" data-id="{{ $comment->id }}" title="Ẩn">
                                <i class="fas fa-eye-slash"></i>
                            </button>
                            @endif

                            <button class="btn btn-danger btn-sm btn-delete" data-id="{{ $comment->id }}" title="Xóa"
