   ...
   @endif
    ...
    <form action="{{ route('admin.discount.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" name="start_date" id="start_date" class="form-control" required value="{{ old('start_date') }}">
            @error('start_date')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" name="end_date" id="end_date" class="form-control" required value="{{ old('end_date') }}">
            @error('end_date')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="max_discount" class="form-control" required value="{{ old('max_discount') }}">
            @error('max_discount')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="min_order_value" class="form-control" required value="{{ old('min_order_value') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="user_usage_limit" class="form-control" required value="{{ old('user_usage_limit') }}">
