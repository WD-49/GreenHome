...
<li class="nav-item">
    ...
    <ul class="collapse list-unstyled ps-3 {{ request()->is('admin/discount*') ? 'show' : '' }}" id="discountSubmenu">
        <li class="nav-item">
            <a href="{{ route('admin.discount.index') }}" class="nav-link {{ request()->routeIs('admin.discount.index') ? 'active' : '' }}">Danh sách</a>
        </li>
        {{-- <li class="nav-item">
