            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" name="status">
                        <option value="" {{ old('status') === null ? 'selected' : '' }}>Chọn trạng thái</option>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('date_of_entry') is-invalid @enderror"
                        ...
                        value="{{ old('date_of_entry', isset($product->date_of_entry) ? \Carbon\Carbon::parse($product->date_of_entry)->format('Y-m-d') : '') }}">
                    @error('date_of_entry')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
