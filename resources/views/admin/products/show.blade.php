                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-body font-tapeli">
                            <div class="d-flex align-items-center mb-4">
                                <img src="{{ asset('storage/' . $product->image) }}" class="img-fluid rounded"
                                    alt="Thumbnail" style="width:220px; height:auto; object-fit:cover; margin-right:3rem;">
                                <div class="ms-5">
                        ...
                        <ul class="nav nav-underline border-bottom pt-2" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link p-2" id="comment_tab" data-bs-toggle="tab" href="#comment"
                                    role="tab">
                            ...
                            <li class="nav-item">
                                <a class="nav-link p-2" id="variant_tab" data-bs-toggle="tab" href="#variant"
                                    role="tab">
