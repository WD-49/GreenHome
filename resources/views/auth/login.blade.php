                    ...
                    <div class="cr-login" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
                        ...
                        <form class="cr-content-form" method="POST" action="{{ route('login') }}">@csrf
                            <div class="form-group">
                                <label>Email *</label>
                                <input id="email" type="email" placeholder="Nhập email" class="cr-form-control  @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <input id="password" type="password" placeholder="Nhập mật khẩu" class="cr-form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
