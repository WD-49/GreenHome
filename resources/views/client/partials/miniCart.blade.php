                ...
                <ul class="crcart-pro-items">
                    <li>
                        <a href="product-left-sidebar.html" class="crside_pro_img">
                            <img src="{{ asset('assets_client/assets/img/product/4.jpg') }}" alt="product-1">
                        </a>
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="crside_pro_img">
                            <img src="{{ asset('assets_client/assets/img/product/2.jpg') }}" alt="product-2">
                        </a>
                        <div class="cr-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="crside_pro_img">
                            <img src="{{ asset('assets_client/assets/img/product/3.jpg') }}" alt="product-3">
                        </a>
                        <div class="cr-pro-content">
